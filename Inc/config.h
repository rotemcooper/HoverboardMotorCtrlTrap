...
#define CONTROL_BAUD       9600  //19200    // control via usart from eg an Arduino or raspberry
...
//rotemc #define CONTROL_ADC                 // use ADC as input. disable CONTROL_SERIAL_USART2!
